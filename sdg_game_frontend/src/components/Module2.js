...
import { SDG1Quiz } from './QuizModule';
import { SDG2Quiz } from './QuizModule';
import { SDG3Quiz } from './QuizModule';
import { SDG4Quiz } from './QuizModule';
import { SDG5Quiz } from './QuizModule';
import { SDG6Quiz } from './QuizModule';
import { SDG7Quiz } from './QuizModule';
import { SDG8Quiz } from './QuizModule';
import { SDG9Quiz } from './QuizModule';
import { SDG10Quiz } from './QuizModule';
import { SDG11Quiz } from './QuizModule';
import { SDG12Quiz } from './QuizModule';
import { SDG13Quiz } from './QuizModule';
import { SDG14Quiz } from './QuizModule';
import { SDG15Quiz } from './QuizModule';
import { SDG16Quiz } from './QuizModule';
import { SDG17Quiz } from './QuizModule';
...
const LandingPage = () => {
  ...
  const sdgCards = [
  {
    ...
    description: 'End poverty in all forms.',
    questions: [
      { question: 'What is poverty?', answer: 'Poverty is not having enough money for basic needs like food and shelter.' },
      { question: 'Why is it happening?', answer: 'it happens because of inequality, lack of jobs, and poor access to education.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by creating jobs, improving education, and helping people in need.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has fair access to opportunities and support.' }
    ],
    quizLink: '/quizzes/sdg1',
    QuizComponent: SDG1Quiz,
  },
  {
    number: 2,
    title: 'Zero Hunger',
    ...
    description: 'End hunger and achieve food security.',
    questions: [
      { question: 'What is zero hunger?', answer: 'Zero hunger means everyone has enough nutritious food.' },
      { question: 'Why is it happening?', answer: 'Hunger happens because of poverty, conflict, and lack of access to food.' },
      { question: 'How can we prevent it?', answer: 'We can prevent hunger by producing more food and sharing it fairly.' },
      { question: 'When can we stop it?', answer: 'We can stop hunger when everyone has enough food globally' }
    ],
    QuizComponent: SDG2Quiz,
  },
  {
    number: 3,
    title: 'Good Health and Well-being',
    ...
    description: 'Ensure healthy lives.',
    questions: [
      { question: 'What is good health and well-being?', answer: 'It means everyone is healthy with access to care.' },
      { question: 'Why is it happening?', answer: 'Poor health happens due to lack of healthcare and bad living conditions.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by improving healthcare and promoting healthy habits.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has access to good healthcare and makes healthy choices' }
    ],
    QuizComponent: SDG3Quiz,
  },
  {
    number: 4,
    title: 'Quality Education',
    ...
    description: 'Promote lifelong learning.',
    questions: [
      { question: 'What is quality education?', answer: 't means providing effective learning for everyone.' },
      { question: 'Why is it happening?', answer: 'It happens due to lack of resources and trained teachers.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by investing in schools and training teachers.' },
      { question: 'When can we stop it?', answer: 'We can stop it when all children have access to good education' }
    ],
    QuizComponent: SDG4Quiz,
  },
  {
    number: 5,
    title: 'Gender Equality',
    ...
    description: 'Achieve gender equality.',
    questions: [
      { question: 'What is gender equality?', answer: 'It means everyone has the same rights and opportunities, no matter their gender' },
      { question: 'Why is it happening?', answer: 'It happens because of discrimination and cultural norms.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by promoting equal rights and empowering all genders' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has equal opportunities and rights.' }
    ],
    QuizComponent: SDG5Quiz,
  },
  {
    number: 6,
    title: 'Clean Water and Sanitation',
    ...
    description: 'Ensure availability and sustainable water management.',
    questions: [
      { question: 'What is clean water and sanitation?', answer: 'It means having safe drinking water and proper hygiene facilities' },
      { question: 'Why is it happening?', answer: 'It happens because of pollution, poor infrastructure, and poverty.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by improving water systems and sanitation facilities.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has access to safe water and sanitation.' }
    ],
    QuizComponent: SDG6Quiz,
  },
  {
    number: 7,
    title: 'Affordable and Clean Energy',
    ...
    description: 'Ensure access to affordable, reliable energy.',
    questions: [
      { question: 'What is affordable and clean energy?', answer: 'It means having cheap, reliable, and eco-friendly energy for everyone.' },
      { question: 'Why is it happening?', answer: 'It happens because of using fossil fuels and expensive energy systems.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by using renewable energy and improving efficiency.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has access to clean, affordable energy.' }
    ],
    QuizComponent: SDG7Quiz,
  },
  {
    number: 8,
    title: 'Decent Work and Economic Growth',
    ...
    description: 'Promote sustained economic growth.',
    questions: [
      { question: 'What is decent work and economic growth?', answer: 'It means having fair jobs and growing the economy' },
      { question: 'Why is it happening?', answer: 'It happens because of unemployment and poor working conditions.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by creating jobs and supporting fair work practices.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has access to good jobs and the economy improves.' }
    ],
    QuizComponent: SDG8Quiz,
  },
  {
    number: 9,
    title: 'Industry, Innovation, and Infrastructure',
    ...
    description: 'Build resilient infrastructure.',
    questions: [
      { question: 'What is industry, innovation, and infrastructure?', answer: 'It means building strong industries, encouraging new ideas, and improving infrastructure.' },
      { question: 'Why is it happening?', answer: 'It happens because of old infrastructure and low investment.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by investing in better infrastructure and supporting innovation.' },
      { question: 'When can we stop it?', answer: 'We can stop it when industries grow and infrastructure is modern everywhere.' }
    ],
    QuizComponent: SDG9Quiz,
  },
  {
    number: 10,
    title: 'Reduced Inequalities',
    ...
    description: 'Reduce inequality within and among countries.',
    questions: [
      { question: 'What is reduced inequalities?', answer: 't means giving everyone equal opportunities.' },
      { question: 'Why is it happening?', answer: 'It happens because of discrimination and unequal access to resources' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by promoting fairness and equal access to jobs and education.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone has equal opportunities.' }
    ],
    QuizComponent: SDG10Quiz,
  },
  {
    number: 11,
    title: 'Sustainable Cities and Communities',
    ...
    description: 'Make cities inclusive, safe, and resilient.',
    questions: [
      { question: 'What are sustainable cities and communities?', answer: 'It means cities that are safe, green, and good for everyone.' },
      { question: 'Why is it happening?', answer: 'It happens because of fast growth and poor planning.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by planning better and reducing pollution.' },
      { question: 'When can we stop it?', answer: 'We can stop it when cities are built to be sustainable and livable for all.' }
    ],
    QuizComponent: SDG11Quiz,
  },
  {
    number: 12,
    title: 'Responsible Consumption and Production',
    ...
    description: 'Ensure sustainable consumption and production patterns.',
    questions: [
      { question: 'What is responsible consumption and production?', answer: 'It means using resources wisely and creating less waste.' },
      { question: 'Why is it happening?', answer: 'It happens because of overconsumption and poor waste management.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by reducing waste and promoting sustainable practices.' },
      { question: 'When can we stop it?', answer: 'We can stop it when everyone uses resources responsibly.' }
    ],
    QuizComponent: SDG12Quiz,
  },
  {
    number: 13,
    title: 'Climate Action',
    ...
    description: 'Take urgent action to combat climate change.',
    questions: [
      { question: 'What is life below water?', answer: 'Life below water refers to the health and sustainability of ocean and marine ecosystems.' },
      { question: 'Why is it happening?', answer: 'It is happening due to pollution, overfishing, and habitat destruction.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by reducing pollution, enforcing sustainable fishing practices, and protecting marine habitats.' },
      { question: 'When can we stop it?', answer: 'We can stop it when the oceans are healthy and marine ecosystems are protected.' }
    ],
    QuizComponent: SDG13Quiz,
  },
  {
    number: 14,
    title: 'Life Below Water',
    ...
    description: 'Conserve and sustainably use the oceans.',
    questions: [
      { question: 'What is life on land?', answer: 'Life on land refers to the health and sustainability of terrestrial ecosystems, including forests, mountains, and biodiversity.' },
      { question: 'Why is it happening?', answer: 'It is happening due to deforestation, habitat loss, and climate change.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by conserving natural habitats, restoring ecosystems, and promoting sustainable land use.' },
      { question: 'When can we stop it?', answer: 'We can stop it when ecosystems are restored and biodiversity is protected.' }
    ],
    QuizComponent: SDG14Quiz,
  },
  {
    number: 15,
    title: 'Life on Land',
    ...
    description: 'Protect and restore ecosystems on land.',
    questions: [
      { question: 'What is peace, justice, and strong institutions?', answer: 'It means having harmony, fairness, and effective governance.' },
      { question: 'Why is it happening?', answer: 'It happens because of conflict, corruption, and weak laws.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by promoting good governance and resolving conflicts peacefully.' },
      { question: 'When can we stop it?', answer: 'We can stop it when societies are peaceful and have fair systems.' }
    ],
    QuizComponent: SDG15Quiz,
  },
  {
    number: 16,
    title: 'Peace, Justice and Strong Institutions',
  ...
  },
  {
    ...
    description: 'Strengthen the means of implementation and revitalize global partnerships.',
    questions: [
      { question: 'What is partnership for the goals?', answer: 'It means collaborating to achieve sustainable development goals' },
      { question: 'Why is it happening?', answer: 'It happens because we need teamwork to solve global problems.' },
      { question: 'How can we prevent it?', answer: 'We can prevent it by promoting cooperation between countries and organizations.' },
      { question: 'When can we stop it?', answer: 'We can stop it when partnerships successfully achieve all sustainable development goals.' }
    ],
    QuizComponent: SDG17Quiz,
  }
];
